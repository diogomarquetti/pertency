...
import { UF_OPTIONS, type MantenedoraValues } from "@/app/(app)/minha-escola/schema";

export function MantenedoraEnderecoContatoCard({
  control,
}: {
  ...
  return (
    <Card className="gap-4 p-[24px]">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <FormField
          control={control}
          name="whatsappInstitucional"
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                WhatsApp institucional <span className="font-normal text-muted">(opcional)</span>
              </FormLabel>
              <FormControl>
                <PhoneInput value={field.value} onChange={field.onChange} />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="email" placeholder="contato@mantenedora.org.br" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                Site <span className="font-normal text-muted">(opcional)</span>
              </FormLabel>
              <FormControl>
                <Input placeholder="https://www.mantenedora.org.br" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
